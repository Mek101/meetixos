...
//                              -> Self {
//         Self { m_hw_addr: HwVirtAddr::from_4kib_indices(l4_index, l3_index,
// l2_index,                                                         l1_index) }
//     }
//
//     /**
...
//                              l2_index: PageTableIndex)
//                              -> Self {
//         Self { m_hw_addr: HwVirtAddr::from_2mib_indices(l4_index, l3_index,
// l2_index) }     }
//
//     /**
//      * Constructs a `VirtAddr` from the given 2 page table indices
//      */
//     pub fn from_1gib_indices(l4_index: PageTableIndex, l3_index:
// PageTableIndex) -> Self {         Self { m_hw_addr:
// HwVirtAddr::from_1gib_indices(l4_index, l3_index) }     }
//
//     /**
