...
pub struct LoaderInfo {
    ...
    /* ranges to unmap when in OldKernel context */
    m_loader_reserved_range: VirtFrameRangeIncl<Page2MiB>,
    m_loader_mapped_range: VirtFrameRangeIncl<Page2MiB>,

    /* OldKernel symbols, part of the loader text */
    m_kern_symbols: *const u8,
    m_kern_symbols_len: usize,

    /* the name of the bootloader which have booted the entire OldKernel */
...
impl LoaderInfo {
    ...
    /**
     * Returns the OldKernel symbols as slice
     */
