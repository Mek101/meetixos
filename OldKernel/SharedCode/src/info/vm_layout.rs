...
/**
 * Fixed collection of `VMLayoutArea` which defines the OldKernel core's
...
impl VMLayout {
    ...
    /**
     * Returns the reference to the `VMLayoutArea` of OldKernel's text
     */
    ...
    /**
     * Returns the reference to the `VMLayoutArea` of OldKernel's heap
     */
    ...
    /**
     * Returns the reference to the `VMLayoutArea` of OldKernel's stack
     */
...
/**
 * Virtual memory area for the OldKernel's layout
 */
